...
TITLE_EMB_PATH = DATA_BUFFER_DIR / "title_emb.parquet"
SUMMARY_EMB_PATH = DATA_BUFFER_DIR / "summary_emb.parquet"
TEMP_ART_LOG_CSV = DATA_BUFFER_DIR / "art_s3_log.csv"
TEMP_TITLE_VEC_LOG_CSV = DATA_BUFFER_DIR / "title_vec_log.csv"
TEMP_SUMMARY_VEC_LOG_CSV = DATA_BUFFER_DIR / "summary_vec_log.csv"
FETCHED_ARTICLES_CSV = DATA_BUFFER_DIR / "fetched_articles.csv"
FETCHED_TITLE_EMBS_FILES = DATA_BUFFER_DIR / "fetched_title_embs.parquet"
FETCHED_SUMMARY_EMBS_FILES = DATA_BUFFER_DIR / "fetched_summary_embs.parquet"
